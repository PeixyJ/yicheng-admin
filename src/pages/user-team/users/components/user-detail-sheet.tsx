            ...
            <>
                ...
                <div className='flex items-start gap-5'>
                  <div className='group relative'>
                    <Avatar className='h-20 w-20 ring-4 ring-background shadow-lg'>
                      ...
                      <AvatarFallback className='text-xl'>{user.nickname.slice(0, 2)}</AvatarFallback>
                    </Avatar>
                    <button
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab} className='w-full'>
                <TabsList className='w-full justify-start rounded-none border-b bg-transparent px-6'>
                  ...
                  <TabsTrigger value='logins' className='rounded-none border-b-2 border-transparent data-[state=active]:border-primary'>
                    登录记录
                  </TabsTrigger>
                  ...
                  <div className='grid gap-6'>
                    <div>
                      ...
                      <div className='grid grid-cols-2 gap-4'>
                        ...
                        <InfoCard label='个人空间ID' value={String(user.personalTeamId)} />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className='grid grid-cols-2 gap-4'>
                        <InfoCard label='邀请人ID' value={user.invitedByUserId ? String(user.invitedByUserId) : null} />
                ...
                <TabsContent value='devices' className='mt-0 p-6'>
                  <div className='space-y-3'>
                    {devices.length === 0 ? (
                      ...
                      devices.map((device) => (
                        <div key={device.id} className='flex items-center justify-between rounded-lg border bg-card p-4'>
