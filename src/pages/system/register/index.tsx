    ...
    <>
      ...
      <div className='flex flex-col gap-6'>
        ...
        <div>
          ...
          <p className='text-muted-foreground'>Start your journey with YiCheng Admin.</p>
        </div>
        ...
        <div className='space-y-4'>
          ...
          <div className='flex justify-center gap-3'>
            ...
            >
              ...
              <span className='sr-only'>Sign up with Email Password</span>
            </Button>
            {/* Email OTP */}
            <Button
              variant='outline'
            ...
            >
              ...
              <span className='sr-only'>Sign up with Email OTP</span>
            </Button>
            {/* GitHub */}
